...
ws2812b contains several parts:
   ...
   - ## To use driver:
      ...
      clear() method in [operations.h](operations.h) can be used to set all leds to rgb(0,0,0).  
      setLED() method in [operations.h](operations.h) can be used to set n-th led in framebuffer.  
      setLEDxy() method in [operations.h](operations.h) can be used to set led positioned at (x,y) on framebuffer.  
      shiftLeft() / shiftRight() method in [operations.h](operations.h) can be used to shift the framebuffer in Y direction.
   ...
   - ### layout.h
       ...
       <img src="images/img6.jpg" alt="Drawing" width="200px"/>
       <img src="images/img3.jpg" alt="Drawing" width="150px"/>
       <img src="images/img4.jpg" alt="Drawing" width="200px"/>
       <img src="images/img5.jpg" alt="Drawing" width="200px"/>
